...
protected:
    static inline QString getNameSqlite(int sqliteType) {
        switch (sqliteType) {
    ...
    static inline QString getNameMySql(int mysqlType) {
        switch (mysqlType) {
    ...
    static inline QString getNamePostgreSql(int pgType) {
        switch (pgType) {
    ...
    static inline QString getNameOracle(int ociType) {
        switch (ociType) {
        /* input data types */
